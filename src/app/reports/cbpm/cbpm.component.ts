...
@Component({
  selector: 'app-report-cbpm',
  templateUrl: './cbpm.component.html',
  styleUrls: ['./cbpm.component.scss']
})
export class CbpmComponent implements OnInit {
  ...
  getTrials() {
    ...
    let searchString = ('?approved_level=-1&legacy_data=No&trial_type__type=CBPM'+'&limit_start='+limit_start+'&limit_end='+limit_end+'&'+ this.param);
    this.api
