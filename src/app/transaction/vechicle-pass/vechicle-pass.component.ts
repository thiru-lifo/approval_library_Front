...
@Component({
  selector: 'app-vechicle-pass',
  templateUrl: './vechicle-pass.component.html',
  styleUrls: ['./vechicle-pass.component.scss']
})
export class VechiclePassComponent implements OnInit {
